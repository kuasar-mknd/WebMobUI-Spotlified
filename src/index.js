import { getArtists, getSongsForArtist, getArtist } from './api'
    ...
    case '#artists':
      ...
      console.log('---------------------------------------------')
        ...
        if (hash[1]) {
          ...
          // changer valeur h4 de la section id list-section avec le nom de l'artiste
          ...
          artistName.querySelector('a').innerHTML = "Artiste > "
